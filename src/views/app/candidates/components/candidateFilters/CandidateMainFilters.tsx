...
import { CandidatePayloadQueryTypes, PositionPayloadQueryTypes } from 'services'

import * as S from '../../../positions/components/mainFilters/MainFilters.styles'

import { CandidateFilters } from './CandidateFilters'

interface CandidateMainFiltersPropTypes {
  fullWidth?: boolean
}
...
export const CandidateMainFilters: React.FC<CandidateMainFiltersPropTypes> = ({
  fullWidth = false,
}) => {
      ...
      >
        ...
        >
          <S.InputBase
            ...
            value={candidateName}
            placeholder={
              isDevice.from.sm ? 'Pesquise pelo nome do candidato' : 'Nome'
            }
            onChange={(e) => {
